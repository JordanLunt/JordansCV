...
function checkStraightFlushHighCards(cards) {
    ...
    if (JSON.stringify(cards) === JSON.stringify(straightFlushClubsKing)||JSON.stringify(cards) === JSON.stringify(straightFlushClubsQueen)||JSON.stringify(cards) === JSON.stringify(straightFlushClubsJack)||JSON.stringify(cards) === JSON.stringify(straightFlushClubsTen)||JSON.stringify(cards) === JSON.stringify(straightFlushDiamondsKing)||JSON.stringify(cards) === JSON.stringify(straightFlushDiamondsQueen)||JSON.stringify(cards) === JSON.stringify(straightFlushDiamondsJack)||JSON.stringify(cards) === JSON.stringify(straightFlushDiamondsTen)||JSON.stringify(cards) === JSON.stringify(straightFlushHeartsKing)||JSON.stringify(cards) === JSON.stringify(straightFlushHeartsQueen)||JSON.stringify(cards) === JSON.stringify(straightFlushHeartsJack)||JSON.stringify(cards) === JSON.stringify(straightFlushHeartsTen)||JSON.stringify(cards) === JSON.stringify(straightFlushSpadesKing)||JSON.stringify(cards) === JSON.stringify(straightFlushSpadesQueen)||JSON.stringify(cards) === JSON.stringify(straightFlushSpadesJack)||JSON.stringify(cards) === JSON.stringify(straightFlushSpadesTen)){
        return name; // all Functions
    }
    else {
        return '';
    }
...
function checkFlush(cards) {
    ...
    for (let cardCheck = 0; cardCheck <= 4; cardCheck++) {
        ...
        if (cardCheck !== 0) {
            ...
            var tenCardPresent = cards[0];
        
            if(tenCardPresent.length > 2){
            console.log("A ten Card is Present") 
            if(myCard.charAt(1)=== tenCardPresent.charAt(2)) {
                if(cardCheck=== 4 ){
                    return name;
                }
            }
...
function checkStraightHighCard(cards){
